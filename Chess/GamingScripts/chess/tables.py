...
class Table:
    ...
    def draw(self,style: str = "comicsansms",foreground: Color = (255,255,255),background: Color = (0,0,0),size: int = 40,bold: bool = False,italic: bool = False,underline: bool = False) -> None:
        ...
        self.render_text(
            self.x if self.x else self.destination.get_width()/2-self.screen.get_width()/2,
            self.y if self.y else self.destination.get_height()/2-self.screen.get_height()/2,
            bold=True,underline=True,size=80)
    ...
    def render_text(self,left: int,top: int,style: str = "comicsansms",foreground: Color = (255,255,255),background: Color = (0,0,0),size: int = 40,bold: bool = False,italic: bool = False,underline: bool = False) -> None:
        font.init()
        ...
        for row in self.text:
            for text in self.text[row]:
                ...
                self.screen.blit(rendered_text,(left,top))

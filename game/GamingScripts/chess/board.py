...
#        self.file,self.rank = self.get_game_pos(x=column,y=row)
        ...
        self.matterial = {
            'BLACK': {
                ...
                'King': [
                    King(self.images['BLACK']['King'],'E',8,BLACK,0,self.win_width,0,self.win_height,self.square_width,self.square_height,self.win_width,self.win_height)
                ],
                'Knight': [
                ...
                'Pawn': [
                    ...
                    Pawn(self.images['BLACK']['Pawn'], 'C', 7, BLACK, 0, self.win_width, 0, self.win_height,self.square_width, self.square_height, self.win_width, self.win_height),                    Pawn(self.images['BLACK']['Pawn'],'A',7,BLACK,0,self.win_width,0,self.win_height,self.square_width,self.square_height,self.win_width,self.win_height),
            ...
            'WHITE': {
                ...
                'King': [
                    King(self.images['WHITE']['King'],'E',1,WHITE,0,self.win_width,0,self.win_height,self.square_width,self.square_height,self.win_width,self.win_height)
                ],
                'Knight': [
